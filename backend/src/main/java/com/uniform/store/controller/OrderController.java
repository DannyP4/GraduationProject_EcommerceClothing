...
public class OrderController {
    ...
    public ApiResponse<PageResponse<OrderSummaryDto>> listOrders(Authentication authentication,
        ...
        return ApiResponse.ok(orderService.listOrders(authentication.getName(), pageable, locale));
    }
    ...
    public ApiResponse<OrderDetailDto> getOrder(Authentication authentication,
                                                ...
                                                @RequestHeader(value = "Accept-Language", required = false) String acceptLanguage) {
        String locale = localeResolver.resolve(acceptLanguage);
        return ApiResponse.ok(orderService.getOrder(authentication.getName(), orderNumber, locale));
    }
