  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-xs text-black/50 mt-1">Taxonomy tree — parent / child categories with translations.</p>
      </div>
      ...
      <div className="border border-dashed border-black/20 bg-white px-6 py-20 text-center">
        ...
        <p className="font-['Anton'] text-3xl uppercase tracking-tight mb-2">Category editor</p>
        <p className="text-sm text-black/50 max-w-md mx-auto mb-6">
          Hierarchical CRUD for categories (parent / child), slug + multi-locale translations.
          Manage taxonomy before products so SKUs slot into the right tree.
        </p>
        <Link
          to="/admin"
